...
const rancher_1 = __importDefault(__nccwpck_require__(5604));
...
class Rancher {
    ...
    fetchProjectWorkloadsAsync(project) {
        return __awaiter(this, void 0, void 0, function* () {
            const { links } = project;
            const req = yield axios_1.default.get(links.workloads, { headers: this.headers });
            return req.data;
        });
    }
    changeImageAsync(wl, config) {
        return __awaiter(this, void 0, void 0, function* () {
            const { links } = wl;
            const req = yield axios_1.default.get(links.self, { headers: this.headers });
            if (req.status === 404) {
                const data = {
                    containers: [
                ...
                const req2 = yield axios_1.default.post(links.update, JSON.stringify(data), { headers: this.headers });
                return req2.data;
            }
            else {
                ...
                yield axios_1.default.put(actions.redeploy, JSON.stringify(data), { headers: this.headers });
                const req2 = yield axios_1.default.put(actions.redeploy, JSON.stringify(data), { headers: this.headers });
                return req2.data;
            }
        });
    }
